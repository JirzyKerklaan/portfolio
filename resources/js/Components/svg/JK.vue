...
onMounted(() => {
    ...
    paths.forEach(path => {
        ...
        path.style.fill = 'none'; // hide fill during draw
        ...
        gsap.to(path, {
            ...
            scrollTrigger: {
                ...
                start: 'top 80%',   // animation starts when SVG top is 80% from top of viewport
                end: 'bottom 20%',  // optional, defines the end of the scroll trigger
